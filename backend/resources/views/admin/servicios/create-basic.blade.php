...
<div class="mt-3">
    <div class="alert alert-info">
        <h6><i class="bi bi-info-circle"></i> Nota sobre imágenes:</h6>
        <p class="mb-0">Actualmente solo se pueden subir imágenes locales. Las URLs externas estarán disponibles próximamente después de solucionar un error técnico.</p>
    </div>
</div>
@endsection
