        ...
        <form action="{{ route('admin.servicios.update', $servicio) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <input type="url" name="imagen_url" id="imagen_url" class="form-control" placeholder="https://images.unsplash.com/photo-..." value="{{ old('imagen_url', isset($servicio->imagen_url) ? $servicio->imagen_url : '') }}">
